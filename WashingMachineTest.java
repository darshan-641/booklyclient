...
public class WashingMachineTest {
	public static void main(String[] args) {
		...
		System.out.println("--------- WELCOME TO DARSHAN'S LAUNDRY ----------------");
		System.out.println("It's a personalized laundry for you at your doorstep, you just answer few questions");
		
		System.out.println("Enter number of cloths you want to wash");
		Scanner scanner = new Scanner(System.in);
		int numberOfCloths = scanner.nextInt();
		// String typeOfCloth, colorOfCloth;
		boolean isClean = false;

		ArrayList<Cloth> ClothArray = new ArrayList<>();
		for( int i=0; i<numberOfCloths; i++){
			...
			String colorOfCloth = scanner.next();

			System.out.println("Is it clean or not? press y or n\n");
			String clean = scanner.next();

			if( clean == "y") isClean = true;
			Cloth c = new Cloth(colorOfCloth, 5, typeOfCloth, isClean);
			ClothArray.add(c);
		}
		System.out.println(ClothArray.toString());
		ClothArray.toString();


		
		WashingPowder washPowder = new WashingPowder(100,"Nirma", "Front Load", true, 10.0f);
		Water water = new Water("clean", 2000, "27");

		System.out.println("wash powder : "+washPowder); //toString is invoked

		Laundry laundry = new Laundry(0, 0, 0, 20000, 0, 10);
...
class WashingMachine extends Machine { //isA
	...
	WashingTub washTub = new WashingTub(500,"Plastic"); //hasA
...
class Laundry {
	...
	private ArrayList<Cloth> clothToWash;
...
class Cloth {
	...
	public Cloth( String color, float cost, String type, boolean clean) {
		super();
	...
	@Override
	public String toString() {
		return "Cloth [ color=" + color + ", cost=" + cost + ", type=" + type + ", clean="
				+ clean + "]";
	}
